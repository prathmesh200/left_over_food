...
public class RegisterActivity_Donor extends AppCompatActivity {
    EditText name,password,email,phone,con_pass,restaurant_name;
    TextView logNow;
    Button regBtn;
    DB_DONAR ForDonar;

    String str_name,str_pass,str_email,str_con_pass,str_phone,str_restaurantName;
...
//        progressDialog.setCanceledOnTouchOutside(false);
    ...
    private void Validation(){
        ...
        str_restaurantName = restaurant_name.getText().toString();
        ...
        if(str_restaurantName.isEmpty()){
            restaurant_name.setError("Please fill field");
            restaurant_name.requestFocus();
            return;
        }

        boolean checkuserForDonor = ForDonar.checkUsernameInDonar(str_name);
        ...
        if(!checkuserForDonor && !checkuserForVolunteer){
            if(checkEmailForUserInDonar || checkEmailForUserInVolunteer){
                ...
                boolean insert = ForDonar.addUsersInDonar(str_name, str_pass, str_email, str_phone, str_restaurantName);
                if (insert) {
